        ...
        private void The_Run_Click(object sender, EventArgs e)
        {
            ...
            if (Browse.Text.Length > 0)
            {
                try
                {
                    ...
                    dataGridView1.DataSource = simulation_run.SimulationCases;
                    //Performance Output
                    EndingAverage.Text = simulation_run.PerformanceMeasures.EndingInventoryAverage.ToString();
                    EndingAverage.ReadOnly = true;
                    ShortageAverage.Text = simulation_run.PerformanceMeasures.ShortageQuantityAverage.ToString();
                    ShortageAverage.ReadOnly = true;
